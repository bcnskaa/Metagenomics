...
"""
def run_EMIRGE(read_1_fn, read_2_fn, DIR=MARKER_OUTDIR + "/EMIRGE", out_fa_fn=None, ssu_fn=EMIRGE_16S_DB, ssu_bowtie_fn=EMIRGE_16S_DB, platform_illumina=True, num_threads=14):
