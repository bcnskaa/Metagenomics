...
#     maxbin_outdir = run_MaxBin(contig_fn, merged_read_fn, maxbin_outprefix=run_id)
    ...
    maxbin_outdir = "/disk/rdisk08/siukinng/samples/lab/GZ-cell_S1/900/MaxBin"
    contig_fn = "/disk/rdisk08/siukinng/samples/lab/GZ-cell_S1/900/idba_ud/contig.fa"
    ...
    if os.path.isfile(blast_outdir + "/" + blast_outfn):
        ...
        if len(sid_fn) == 1:
            ...
            # The contig abundance will be treated as coverage 
